...
namespace Server.Mobiles
{
	...
	public class BloodSteelBalron : BaseCreature
	{
		[Constructable]
		public BloodSteelBalron() : base( AIType.AI_SphereMage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public BloodSteelBalron( Serial serial ) : base( serial )
		{
		}
