...
namespace Server.Mobiles
{
	...
	public class SapphireBalron : BaseCreature
	{
		[Constructable]
		public SapphireBalron() : base( AIType.AI_SphereMage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public SapphireBalron( Serial serial ) : base( serial )
		{
		}
