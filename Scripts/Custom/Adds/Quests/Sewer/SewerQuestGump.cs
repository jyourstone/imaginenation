...
{ public class SewerQuestGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "SewerQuestGump", AccessLevel.GameMaster, SewerQuestGump_OnCommand ); 
}
private static void SewerQuestGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new SewerQuestGump( e.Mobile ) ); } 
public SewerQuestGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
