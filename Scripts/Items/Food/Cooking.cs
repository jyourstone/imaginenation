...
namespace Server.Items
{
	...
	public class SweetDough : Item
	{
		...
		private class InternalTarget : Target
		{
			...
			private class InternalTimer : Timer, IAction
			{
				...
				public InternalTimer( Mobile from, Campfire campfire ) : base( TimeSpan.FromSeconds( 2.5 ) )
				{
					m_From = from;
					m_Campfire = campfire;
				}
				...
				protected override void OnTick()
				{
					...
					{
					    m_From.AddToBackpack(new Muffins());
					}
					else
					{
						m_From.SendLocalizedMessage( 500686 ); // You burn the food to a crisp! It's ruined.
	...
	public class PitcherWater : Item
	{
		...
		private class InternalTarget : Target
		{
			private readonly PitcherWater m_Item;
	...
	public class SackFlourOpen : Item
	{
		...
		private class InternalTarget : Target
		{
			private readonly SackFlourOpen m_Item;
