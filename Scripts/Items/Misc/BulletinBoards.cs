...
namespace Server.Items
{
    ...
    {
        [Constructable]
        public BulletinBoard() : base(0x2311)
        {
            Weight = 15.0;
            Name = "Bulletin Board";
        }
    ...
    {
        private BulletinBoardMessage m_Greeting;
        private List<BulletinBoardMessage> m_Messages;
        ...
        {
            m_Messages = new List<BulletinBoardMessage>();
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendGump(new BulletinBoardGump(from, this, 0));
        }

        public class PostPrompt : Prompt
        {
            private readonly int m_Page;
            private readonly BaseBulletinBoard m_Board;
    ...
    public class BulletinBoardMessage
    {
        ...
        public BulletinBoardMessage(GenericReader reader)
        {
