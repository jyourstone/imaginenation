	...
	public class AcceptConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				 ...
				 * Ocllo. Seems all that magic Uzeraan was throwing around when
				 ...
				 * Trust me.<BR><BR>
				 * 
				 * Need you to go fish some up for me. Down at the lake. Ocllo Lake.
	...
	public class ReturnPearlsConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				 ...
				 * them. From the lake. Ocllo. Great job. Gotta love rainbow
	...
	public class ReturnImagesConversation : QuestConversation
	{
		public override object Message
		{
			get
			{
				 ...
				 * them? To Elwood in Ocllo? Yes, I know him. We've done business
