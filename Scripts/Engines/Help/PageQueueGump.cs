...
namespace Server.Engines.Help
{
	public class MessageSentGump : Gump
	{
	    ...
	    private readonly bool m_PageRespone;

		public MessageSentGump( Mobile mobile, string name, string text, bool pageresponse ) : base( 30, 30 )
		{
			m_Name = name;
			m_Text = text;
			m_Mobile = mobile;
		    m_PageRespone = pageresponse;
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
            if (m_PageRespone)
                ...
                m_Mobile.SendGump(new SendMessageGump(m_Mobile, m_Name, m_Text));
