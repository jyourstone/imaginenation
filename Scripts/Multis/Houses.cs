...
namespace Server.Multis
{
	...
	public class Tower : BaseHouse
	{
		...
		public Tower( Mobile owner ) : base( 0x7A, owner, 2119, 15 )
		{
            ...
            AddEastDoor(false, 1, 4, 26, keyValue);
            AddEastDoor(false, 1, 4, 46, keyValue);
		}
	...
	public class Castle : BaseHouse
	{
		...
		public Castle( Mobile owner ) : base( 0x7E, owner, 4076, 28 )
		{
			...
			AddSouthDoors(false, 0, 11, 6, keyValue );  // true
            AddSouthDoors(false, 0, 5, 6, keyValue);  // false
            AddSouthDoors(false, -1, -11, 6, keyValue);  // false
		}
