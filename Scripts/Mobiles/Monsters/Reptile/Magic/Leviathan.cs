...
namespace Server.Mobiles
{
	...
	public class Leviathan : BaseCreature
	{
		...
		[Constructable]
		public Leviathan( Mobile fisher ) : base( AIType.AI_SphereMage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Fisher = fisher;
		...
		public static void GiveArtifactTo( Mobile m )
		{
			...
			if ( m.AddToBackpack( item ) )
				m.SendMessage( "As a reward for slaying the mighty leviathan, an special item has been placed in your backpack." );
			else
