...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public AntLion() : base( AIType.AI_SphereMelee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Ant Lion";
			Body = 787;
			BaseSoundID = 1006;
            ...
            {
                case 0: orepile = new OldCopperOre(); break;
                case 1: orepile = new ShadowIronOre(); break;
                case 2: orepile = new SilverOre(); break;
                default: orepile = new VeriteOre(); break;
            }
