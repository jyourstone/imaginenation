...
namespace Server
{
    ...
    public delegate void GuildChatEventHandler( GuildChatEventArgs e );
    public delegate void PartyChatEventHandler( PartyChatEventArgs e );
    public delegate void AllianceChatEventHandler(AllianceChatEventArgs e);
    ...
    public class GuildChatEventArgs
    {
        private Mobile m_Mobile;
        private BaseGuild m_Guild;
        private string m_Speech;

        public GuildChatEventArgs(Mobile mob, BaseGuild guild, string speech)
        {
            m_Mobile = mob;
            m_Guild = guild;
            m_Speech = speech;
    ...
    public class PartyChatEventArgs
    {
        private Mobile m_Mobile;
        private Mobile m_ToMobile;
        private string m_Speech;

        public PartyChatEventArgs(Mobile from, string speech)
        {
            m_Mobile = from;
            m_Speech = speech;
        }

        public PartyChatEventArgs(Mobile from, Mobile to, string speech)
        {
            m_Mobile = from;
            m_ToMobile = to;
            m_Speech = speech;
        ...
        public Mobile From { get { return m_Mobile; } }
        public Mobile To { get { return m_ToMobile; } }
        public string Speech { get { return m_Speech; } }
    }

    public class AllianceChatEventArgs
    {
        private Mobile m_Mobile;
        private BaseGuild m_Guild;
        private string m_Speech;
    ...
    public static class EventSink
    {
        ...
        public static event GuildChatEventHandler GuildChat;
        public static event PartyChatEventHandler PartyChat;
        public static event AllianceChatEventHandler AllianceChat;

        public static void InvokeGuildChat( GuildChatEventArgs e )
        {
            if (GuildChat != null)
                GuildChat(e);
        }

        public static void InvokePartyChat(PartyChatEventArgs e)
        {
            if (PartyChat != null)
                PartyChat(e);
        }

        public static void InvokeAllianceChat(AllianceChatEventArgs e)
        {
            if (AllianceChat != null)
                AllianceChat(e);
        }
