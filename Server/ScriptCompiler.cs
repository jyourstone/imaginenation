 ...
 *
 *   $Id: ScriptCompiler.cs 812 2012-01-02 21:17:48Z asayre $
 *
 ***************************************************************************/
...
namespace Server
{
    public static class ScriptCompiler
    {
...
#if Framework_3_5
            AppendCompilerOption(ref sb, "/d:Framework_3_5");
#endif
#if Framework_4_0
        ...
        public static bool LoadPrecompiledAssembly()
        {
            ...
            Assembly assembly = Assembly.LoadFrom("Scripts/Output/Scripts.CS.dll");
