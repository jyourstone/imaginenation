...
session_start();
if ( $_SESSION['mobileHash'] == -1 )
	DIE("Cannot access this image.");
...
$link=mysql_connect("localhost", "antimacro", "MHyfhvbjhcmfWp8j") OR DIE("An error occoured");
mysql_select_db("antimacro", $link) OR DIE("An error occoured");
mysql_query("UPDATE CurrentMobiles SET answer='$word' WHERE mobileHash=".$_SESSION['mobileHash']);
...
// output final image :-)
//Reset the session so that you cannot load the image after loading the index page
