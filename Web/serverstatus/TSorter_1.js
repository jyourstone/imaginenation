...
function TSorter(){
	...
	function setGet(sortType)
	{
		...
		{   
			case "link_column":
				get = function(index){
					if(isNaN(getCell(index).firstChild.firstChild.nodeValue)) {
						return getCell(index).firstChild.firstChild.nodeValue;
					} else {
						return parseInt(getCell(index).firstChild.firstChild.nodeValue);
					}
				};
				break;
			default:
				...
				get = function(index)
					{
						...
						if ( cell.firstChild.nodeValue === null ) {
							if ( cell.firstChild.firstChild.nodeValue === null ) {
								return cell.firstChild.firstChild.firstChild.nodeValue;	
							} else {
								return cell.firstChild.firstChild.nodeValue;
							}
						}
						else if(isNaN(cell.firstChild.nodeValue)) {
